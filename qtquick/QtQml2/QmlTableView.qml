...
Item {
    ...
    EasyTableModel{
        id: table_model
        horHeader: ["Name","Cost","Manufacturer"]
        initData: [
            {"name":"iphone XS","cost":20,"manufacturer":"test model view"},
            {"name":"iphone 11","cost":21,"manufacturer":"test model view"},
            {"name":"iphone 11pro","cost":22,"manufacturer":"test model view"},
            {"name":"MI12","cost":23,"manufacturer":"test model view"},
            {"name":"Mate40","cost":24,"manufacturer":"test model view"},
            {"name":"S5","cost":25,"manufacturer":"test model view"},
            {"name":"MI10","cost":26,"manufacturer":"test model view"},
            {"name":"1+","cost":27,"manufacturer":"test model view"}
        ]
    }
    ...
    Column {
        ...
        spacing: 1
        Repeater {
            model: /*table_view.rows > 0 ? table_view.rows : 0*/50
            Rectangle {
